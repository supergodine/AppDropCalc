 ...
 * limitations under the License.
 */
class Zt{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(function(e){const t=e.getComponent();return"VERSION"===t?.type}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null}).filter(e=>e).join(" ")}}const Yt="@firebase/app",Qt="0.14.5",er=new Ot("@firebase/app"),tr="@firebase/app-compat",rr="@firebase/analytics-compat",nr="@firebase/analytics",ar="@firebase/app-check-compat",or="@firebase/app-check",sr="@firebase/auth",ir="@firebase/auth-compat",lr="@firebase/database",cr="@firebase/data-connect",dr="@firebase/database-compat",ur="@firebase/functions",hr="@firebase/functions-compat",pr="@firebase/installations",mr="@firebase/installations-compat",gr="@firebase/messaging",fr="@firebase/messaging-compat",yr="@firebase/performance",br="@firebase/performance-compat",xr="@firebase/remote-config",vr="@firebase/remote-config-compat",wr="@firebase/storage",Cr="@firebase/storage-compat",jr="@firebase/firestore",Sr="@firebase/ai",Nr="@firebase/firestore-compat",Er="firebase",Ir="[DEFAULT]",Tr={[Yt]:"fire-core",[tr]:"fire-core-compat",[nr]:"fire-analytics",[rr]:"fire-analytics-compat",[or]:"fire-app-check",[ar]:"fire-app-check-compat",[sr]:"fire-auth",[ir]:"fire-auth-compat",[lr]:"fire-rtdb",[cr]:"fire-data-connect",[dr]:"fire-rtdb-compat",[ur]:"fire-fn",[hr]:"fire-fn-compat",[pr]:"fire-iid",[mr]:"fire-iid-compat",[gr]:"fire-fcm",[fr]:"fire-fcm-compat",[yr]:"fire-perf",[br]:"fire-perf-compat",[xr]:"fire-rc",[vr]:"fire-rc-compat",[wr]:"fire-gcs",[Cr]:"fire-gcs-compat",[jr]:"fire-fst",[Nr]:"fire-fst-compat",[Sr]:"fire-vertex","fire-js":"fire-js",[Er]:"fire-js-all"},_r=new Map,Pr=new Map,kr=new Map;function Ar(e,t){try{e.container.addComponent(t)}catch(ae){er.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,ae)}}function Rr(e){const t=e.name;if(kr.has(t))return er.debug(`There were multiple attempts to register component ${t}.`),!1;kr.set(t,e);for(const r of _r.values())Ar(r,e);for(const r of Pr.values())Ar(r,e);return!0}function Or(e,t){const r=e.container.getProvider("heartbeat").getImmediate({optional:!0});return r&&r.triggerHeartbeat(),e.container.getProvider(t)}function Dr(e){return null!=e&&void 0!==e.settings}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tn(e){if(e)try{const t=new Date(Number(e));if(!isNaN(t.getTime()))return t.toUTCString()}catch(ae){}}function _n(e){return 1e3*Number(e)}function Pn(e){const[t,r,n]=e.split(".");if(void 0===t||void 0===r||void 0===n)return tn("JWT malformed, contained fewer than 3 sections"),null;try{const e=ot(r);return e?JSON.parse(e):(tn("Failed to decode base64 JWT payload"),null)}catch(ae){return tn("Caught error parsing JWT payload as JSON",ae?.toString()),null}}function kn(e){const t=Pn(e);return cn(t,"internal-error"),cn(void 0!==t.exp,"internal-error"),cn(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class xa extends ya{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return ga._fromParams({providerId:xa.PROVIDER_ID,signInMethod:xa.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return xa.credentialFromTaggedObject(e)}static credentialFromError(e){return xa.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return xa.credential(t,r)}catch{return null}}}xa.GOOGLE_SIGN_IN_METHOD="google.com",xa.PROVIDER_ID="google.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pa extends Ia{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Pa.type="SESSION";const ka=Pa;
/**
 * @license
 * Copyright 2019 Google LLC
 *
