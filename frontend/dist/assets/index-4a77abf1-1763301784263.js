...
to {
  ...
  animation: ${Xe} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Qe=({toast:t})=>{let{icon:r,type:a,iconTheme:s}=t;return void 0!==r?"string"==typeof r?e.createElement(Ye,null,r):r:"blank"===a?null:e.createElement(Ze,null,e.createElement(Ge,{...s}),"loading"!==a&&e.createElement(Ke,null,"error"===a?e.createElement($e,{...s}):e.createElement(Je,{...s})))},et=e=>`\n0% {transform: translate3d(0,${-200*e}%,0) scale(.6); opacity:.5;}\n100% {transform: translate3d(0,0,0) scale(1); opacity:1;}\n`,tt=e=>`\n0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}\n100% {transform: translate3d(0,${-150*e}%,-1px) scale(.6); opacity:0;}\n`,rt=ke("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
 ...
 * limitations under the License.
 */
function zs(){return void 0!==$s().WorkerGlobalScope&&"function"==typeof $s().importScripts}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kn=new Ca(3e4,6e4);function Sn(){const e=$s().___jsl;if(e?.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let r=0;r<e.CP.length;r++)e.CP[r]=null}function jn(e){return new Promise((t,r)=>{function a(){Sn(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Sn(),r(ha(e,"network-request-failed"))},timeout:kn.get()})}if($s().gapi?.iframes?.Iframe)t(gapi.iframes.getContext());else{if(!$s().gapi?.load){const t=`__${"iframefcb"}${Math.floor(1e6*Math.random())}`;return $s()[t]=()=>{gapi.load?a():r(ha(e,"network-request-failed"))},(s=`${xs.gapiScript}?onload=${t}`,xs.loadJS(s)).catch(e=>r(e))}a()}var s}).catch(e=>{throw En=null,e})}let En=null;
/**
 * @license
 * Copyright 2020 Google LLC.
 *
