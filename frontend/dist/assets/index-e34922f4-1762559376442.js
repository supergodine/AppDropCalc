 ...
 * limitations under the License.
 */
ar("firebase","12.5.0","app");const eo={apiKey:"AIzaSyAyBKjN7vrW3sAOVlnlTxVkNvd_9sIYr7s",authDomain:"dropcalc-11fd7.firebaseapp.com",projectId:"dropcalc-11fd7",storageBucket:"dropcalc-11fd7.firebasestorage.app",messagingSenderId:"779840470463",appId:"1:779840470463:web:62b5e584a22c8028a4750a"};console.log("🔥 Firebase Config:",{apiKey:eo.apiKey?"✅ Configurado":"❌ Faltando",authDomain:eo.authDomain,projectId:eo.projectId});const to=function(e=function(e=za){const t=Ga.get(e);if(!t&&e===za&&kt())return tr();if(!t)throw Xa.create("no-app",{appName:e});return t}()){const t=Za(e,"auth");if(t.isInitialized())return t.getImmediate();const a=
/**
 * @license
 * Copyright 2020 Google LLC
 *
